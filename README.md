...
|    | T     | Data structure/graph type \[[exercise](slides/sd013-match-data-to-graph-worksheet.pdf)\]\[[answers](slides/sd013-match-data-to-graph-answers.pdf)\]<br>[D1 data structure](cm/cm301-report-display-reqts.md#D1-distributions)<br>Complete the data structure worksheets<br>[Install software](cm/cm901-software-install.md#install-software)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | D1 data search [sources](cm/cm108-data-sources.md#data-sources) | Doumont reading                                                                                                                          |
