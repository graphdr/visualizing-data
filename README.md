...
| **3**  | M     | ![](resources/icon-moodle-video.png) R Markdown basics (18 min) \[[slides](slides/sd031-rmd-basics.pdf)\]<br>[R Markdown tutorial](cm/cm305-report-rmd-basics.md#R-markdown-basics)<br>[RStudio tips](cm/cm905-software-RStudio-tips.md#rstudio-tips)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | D2 data identified<br>wk2 exercises complete                    |                                                                                                                                          |
