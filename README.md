...
| **4**  | M     | ![](resources/icon-moodle-video.png) Reshaping data introduction<br>[Reshaping data tutorial](cm/cm103-data-reshaping.md#reshaping-data) \[[exercises](cm/cm103-data-reshaping.md#exercises)\]<br>![](resources/icon-r4ds.png) [12.2 Tidy data](https://r4ds.had.co.nz/tidy-data.html#tidy-data-1)<br>![](resources/icon-r4ds.png) [12.4 Separating and uniting](https://r4ds.had.co.nz/tidy-data.html#separating-and-uniting)<br>![](resources/icon-r4ds.png) [12.7 Non-tidy data](https://r4ds.had.co.nz/tidy-data.html#non-tidy-data)                                                                                                                                                                                                                                                                                                                                                                                                               | D3 data identified<br>wk3 exercises complete                    |                                                                                                                                          |
|        | T     | ![](resources/icon-moodle-video.png) Reading discussion introduction<br>![](resources/icon-moodle.png) Wainer ([2014](#ref-Wainer:2014:Sec.2.9)) 15 displays about one thing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | D4 data search [sources](cm/cm108-data-sources.md#data-sources) | [Reading prompts 2](reports/reading-prompts-2.Rmd)                                                                                       |
|        | W lab | Presentations, practice, & portfolio studio<br>![](resources/icon-moodle-video.png) 3P Studio agenda<br>![](resources/icon-moodle-video.png) Applying the discussion notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |                                                                 | D1 graph & prose<br>[Presentation prompts](reports/presentation-prompts.Rmd)                                                             |
|        | R     | ![](resources/icon-moodle-video.png) D2 Multiway introduction<br>D2 Multiway \[[requirements](cm/cm301-report-display-reqts.md#D2-multiway)\]<br>[Multiway dot plot tutorial](cm/cm204-graph-multiway.md#multiway-dot-plot) \[[exercises](cm/cm204-graph-multiway.md#exercises)\]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                                                                 |                                                                                                                                          |
